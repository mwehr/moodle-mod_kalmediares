...
$string['access_restriction_hdr'] = 'Access Restriction';
$string['internal'] = 'Internal only';
$string['view_access_log_hdr'] = 'View Access Log';
// $string['view_access_log'] = 'Student can view onw access counts';
$string['view_access_log'] = 'Publish access counts to students';
...
$string['your_views'] = 'You have visited this page {$a} time(s) before.';
$string{'firstview'} = 'You visited this page for the first time';
$string['your_plays'] = 'Your have played this media {$a} time(s) before.';
$string['not_played_yet'] = 'You don\'t play this media yet.';
